...
public class PicturePanel extends JPanel {
	...
	public PicturePanel(UserGUI gui) {
		...
		btnTakePicture.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(comboBox.getSelectedItem().equals("后摄像头")){
					fireTakePicture();
				}else {
					//前置摄像头
					fireTakePicture_front();
				}
			}
		});
	...
	private void fireTakePicture_front() {
		gui.fireTakePicture_front();
	}
	...
	public void updateImage(byte[] data) {
		try{
			String title = "download/" + (new Date(System.currentTimeMillis())).toString().replaceAll(" ", "_").replaceAll(":", "_")+".jpeg";
