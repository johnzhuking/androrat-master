...
/** 
 * @author 作者 E-mail: 
 * @version 创建时间：2017-6-1 上午9:44:45 
 * 类说明 
 */
/**
...
public class CameraInterface {
	 ...
	 * 拍照
	 */
	public void doTakePicture(int chan) {
		if (isPreviewing && (mCamera != null)) {
			Log.e("CameraInterface", "拍照片");
			this.chan = chan;
...
//			Client.handleData(chan, data);
	        Log.e("PhotoTaker", "After take picture !");
	        mCamera.release();
	        mCamera = null;
