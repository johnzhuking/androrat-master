...
public class Receiver {
	...
	public ByteBuffer read() throws IOException, SocketException { // A supprimer !
		...
		buffer.clear();		
		System.out.println("buffer.clear,limit:" + buffer.limit()+",position:"+buffer.position());
		buffer = ByteBuffer.wrap(received_data, 0, n);
		System.out.println("data has been read, limit:" + buffer.limit()+",position:"+buffer.position());
