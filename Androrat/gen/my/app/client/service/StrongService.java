 ...
 * Original file: D:\\androrat-master\\Androrat\\src\\my\\app\\client\\service\\StrongService.aidl
 */
package my.app.client.service;
public interface StrongService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements my.app.client.service.StrongService
{
private static final java.lang.String DESCRIPTOR = "my.app.client.service.StrongService";
...
/**
 * Cast an IBinder object into an my.app.client.service.StrongService interface,
 * generating a proxy if needed.
 */
public static my.app.client.service.StrongService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof my.app.client.service.StrongService))) {
return ((my.app.client.service.StrongService)iin);
}
return new my.app.client.service.StrongService.Stub.Proxy(obj);
}
...
private static class Proxy implements my.app.client.service.StrongService
{
