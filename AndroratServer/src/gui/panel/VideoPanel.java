...
public class VideoPanel extends JPanel
{
	...
	{
		 NativeLibrary.addSearchPath(RuntimeUtil.getLibVlcLibraryName(), "D:/VideoLAN/VLC64");
...
//	    contentPane.setVisible(true);
	...
	public void fireButtonStartStreaming()
	{
		if (!streaming)
		{
			...
			//filename = formatter.format(new Date(System.currentTimeMillis())) + ".mp4";
			filename=String.format("yyyyMMddHHmmss", new Date(System.currentTimeMillis())) + ".mp4";
